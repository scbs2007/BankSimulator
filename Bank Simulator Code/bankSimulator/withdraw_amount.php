...
<h1 style="background:url(images/withdraw_amount.png) no-repeat; text-indent:-9999px;">Withdraw Amount</h1>

<form id="withdrawAmt" name="withdrawAmt" method="get" action="process_withdraw.php">
<fieldset>

  <label for="cust_id"><span> Customer ID </span>
